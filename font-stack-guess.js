...
function guessBodyFont() {
  ...
  if (probableFont) {
    alert("BODY element is probably using the font family or keyword: \n" + probableFont + "\n\n" + "All matching font names or keywords in the stack: \n" + availableFonts.join("\n") + "\n\n" + "Unavailable fonts: \n" + (unavailableFonts.length > 0 ? unavailableFonts.join("\n") : '(None)') + "\n\n" + "Font stack as reported by getComputedStyle: \n" + stack + "\n\nNote cautions and update this bookmarklet at https://alanhogan.com/bookmarklets#font-stack-guess");
  } else {
